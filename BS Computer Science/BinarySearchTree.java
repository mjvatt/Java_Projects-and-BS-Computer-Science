...
public class BinarySearchTree {
	...
	public void newNode(BinarySearchTree current_node, int x) {
		
		if (x < current_node.value) {
			
			if (current_node.left_child == null) {
				
				current_node.left_child = new BinarySearchTree(x);
			...
			if (current_node.right_child == null) { 
				...
				current_node.right_child = new BinarySearchTree(x);
	...
	public int FindValue(int x) {
		...
		BinarySearchTree current_node = root;
	...
	public static void main(String[] args) {
		...
		BinarySearchTree user_tree = new BinarySearchTree(bst_length);
